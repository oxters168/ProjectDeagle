...
#include "../cginc/VertexColor_UnityStandardInput.cginc"
...
#ifndef V_MM_VERTEX_COLOR
#define V_MM_VERTEX_COLOR
#endif

#ifdef V_MM_STANDARD_FORWARDADD_SM2
...
VertexOutputForwardAdd vertForwardAdd (VertexInput v)
{
	...
	float3 lightDir = _WorldSpaceLightPos0.xyz - posWorld.xyz * _WorldSpaceLightPos0.w;
		...
		#ifdef V_MM_STANDARD_FORWARDADD_SM2
			fixed3 col = fixed3(v.color.r, v.color.g, v.color.b);
...
half4 fragForwardAdd (VertexOutputForwardAdd i) : SV_Target
{
	...
	half4 c = UNITY_BRDF_PBS (s.diffColor, s.specColor, s.oneMinusReflectivity, s.oneMinusRoughness, s.normalWorld, -s.eyeVec.xyz, light, noIndirect);
