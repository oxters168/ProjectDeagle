...
namespace DemoInfo
{
	public class Player
	{
		...
		public Vector3 LastAlivePosition { get; set; }
		...
		public Player Copy()
		{
			...
			//if (Position != null)
				me.Position = Position; //Vector is a class, not a struct - thus we need to make it thread-safe. 

			//if (LastAlivePosition != null)
				me.LastAlivePosition = LastAlivePosition;
